...
using Moq;
using Xunit;
namespace CloudTaskManager.Test
{
    public class TaskControllerTests
    {
        ...
        public async Task CreateTask_ShouldPublishEvent_WhenTaskIsCreated()
        {
            ...
            var controller = new TaskController(db, mockPublisher.Object, It.IsAny<ILogger<TaskController>>(),
                It.IsAny<ICorrelationIdAccessor>())
            {
